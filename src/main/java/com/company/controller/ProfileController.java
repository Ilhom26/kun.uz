...
public class ProfileController {
    ...
    @PostMapping("/image")
    public ResponseEntity<?>updateImage(@RequestBody AttachDTO attachDTO, HttpServletRequest request){
        Integer pId = JwtUtil.getIdFromHeader(request);
        return ResponseEntity.ok(profileService.updateImage(attachDTO.getId(),pId));
    }
